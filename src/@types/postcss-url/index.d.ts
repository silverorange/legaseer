/**
 * Adapted from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/postcss-url/index.d.ts
 *
 * Minor updates applied for postcss-url 10.x and postcss 8.x.
 */
